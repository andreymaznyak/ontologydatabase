...
namespace Meta\ClassificationLegalEntitiesBundle\Tests\Controller;
...
class LegalEntityControllerTest extends WebTestCase
{
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/legalentity/new');
